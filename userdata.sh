...
{ time spark-submit wordcount.py input_datasets output_spark_datasets ; } 2> time_spark_datasets_1.txt
sudo rm -r output_spark_datasets
{ time spark-submit wordcount.py input_datasets output_spark_datasets ; } 2> time_spark_datasets_2.txt
sudo rm -r output_spark_datasets
{ time spark-submit wordcount.py input_datasets output_spark_datasets ; } 2> time_spark_datasets_3.txt
